...
public protocol SwiftHelloBinding_Listener: JavaProtocol {
    ...
    /// public abstract com.johnholdsworth.swiftbindings.SwiftHelloBinding$RenderListener com.johnholdsworth.swiftbindings.SwiftHelloBinding$Listener.getRenderer()
...
open class SwiftHelloBinding_ListenerForward: JNIObjectForward, SwiftHelloBinding_Listener {
    ...
    private static var getRenderer_MethodID_11: jmethodID?

    open func getRenderer() -> SwiftHelloBinding_RenderListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getRenderer", methodSig: "()Lcom/johnholdsworth/swiftbindings/SwiftHelloBinding$RenderListener;", methodCache: &SwiftHelloBinding_ListenerForward.getRenderer_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? SwiftHelloBinding_RenderListenerForward( javaObject: __return ) : nil
    }
    ...
    private static var processStringMap_MethodID_13: jmethodID?
    ...
    open func processStringMap( map: [String:String]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processStringMap", methodSig: "(Lcom/johnholdsworth/swiftbindings/SwiftHelloTypes$StringMap;)V", methodCache: &SwiftHelloBinding_ListenerForward.processStringMap_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var processStringMapList_MethodID_14: jmethodID?
    ...
    open func processStringMapList( map: [String:[String]]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processStringMapList", methodSig: "(Lcom/johnholdsworth/swiftbindings/SwiftHelloTypes$StringMapList;)V", methodCache: &SwiftHelloBinding_ListenerForward.processStringMapList_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var processText_MethodID_15: jmethodID?

    open func processText( text: String? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processText", methodSig: "(Ljava/lang/String;)V", methodCache: &SwiftHelloBinding_ListenerForward.processText_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var processedMap_MethodID_16: jmethodID?
    ...
    open func processedMap( map: [String:SwiftHelloTypes_TextListener]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedMap", methodSig: "(Lcom/johnholdsworth/swiftbindings/SwiftHelloTypes$ListenerMap;)V", methodCache: &SwiftHelloBinding_ListenerForward.processedMap_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var processedMapList_MethodID_17: jmethodID?
    ...
    open func processedMapList( map: [String:[SwiftHelloTypes_TextListener]]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedMapList", methodSig: "(Lcom/johnholdsworth/swiftbindings/SwiftHelloTypes$ListenerMapList;)V", methodCache: &SwiftHelloBinding_ListenerForward.processedMapList_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var setCacheDir_MethodID_18: jmethodID?

    open func setCacheDir( cacheDir: String? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: cacheDir, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCacheDir", methodSig: "(Ljava/lang/String;)V", methodCache: &SwiftHelloBinding_ListenerForward.setCacheDir_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    private static var testResponder_MethodID_19: jmethodID?

    open func testResponder( loopback: Int ) -> SwiftHelloTest_TestListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(loopback) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "testResponder", methodSig: "(I)Lcom/johnholdsworth/swiftbindings/SwiftHelloTest$TestListener;", methodCache: &SwiftHelloBinding_ListenerForward.testResponder_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var throwException_MethodID_20: jmethodID?

    open func throwException() throws /* java.lang.Exception */ -> Double {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "throwException", methodSig: "()D", methodCache: &SwiftHelloBinding_ListenerForward.throwException_MethodID_20, args: &__args, locals: &__locals )
...
private typealias SwiftHelloBinding_Listener_getRenderer_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong ) -> jobject?

private func SwiftHelloBinding_Listener_getRenderer_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong ) -> jobject? {
    let __return = SwiftHelloBinding_ListenerLocal_.swiftObject( jniEnv: __env, javaObject: __this, swiftObject: __swiftObject ).getRenderer( )
    var __locals = [jobject]()
...
private typealias SwiftHelloBinding_Listener_throwException_9_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong ) -> jdouble

private func SwiftHelloBinding_Listener_throwException_9( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong ) -> jdouble {
    do {
...
fileprivate class SwiftHelloBinding_ListenerLocal_: JNILocalProxy<SwiftHelloBinding_Listener, Any> {
    ...
    fileprivate static let _proxyClass: jclass = {
        ...
        let SwiftHelloBinding_Listener_getRenderer_0_thunk: SwiftHelloBinding_Listener_getRenderer_0_type = SwiftHelloBinding_Listener_getRenderer_0
        natives.append( JNINativeMethod( name: strdup("__getRenderer"), signature: strdup("(J)Lcom/johnholdsworth/swiftbindings/SwiftHelloBinding$RenderListener;"), fnPtr: unsafeBitCast( SwiftHelloBinding_Listener_getRenderer_0_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        let SwiftHelloBinding_Listener_throwException_9_thunk: SwiftHelloBinding_Listener_throwException_9_type = SwiftHelloBinding_Listener_throwException_9
        natives.append( JNINativeMethod( name: strdup("__throwException"), signature: strdup("(J)D"), fnPtr: unsafeBitCast( SwiftHelloBinding_Listener_throwException_9_thunk, to: UnsafeMutableRawPointer.self ) ) )
